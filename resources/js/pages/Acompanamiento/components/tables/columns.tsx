...
export const columns: ColumnDef<Carrera>[] = [
    ...
    },
    {
        ...
        size: 140,
        cell: function CarreraActionsCell({ row }) {
                        ...
                        <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        <p>
                                            <strong>Nombre:</strong> {carrera.nombre}
                                        </p>
                                        <p>
                                            <strong>Código:</strong> {carrera.codigo}
                                        </p>
                                    </DialogDescription>
                                </DialogHeader>
                            </DialogContent>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        Esta acción no se puede deshacer. Se eliminará la carrera <strong>{carrera.nombre}</strong>.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                    <AlertDialogAction className="bg-red-600 hover:bg-red-700" onClick={eliminarCarrera}>
                                        Eliminar
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
