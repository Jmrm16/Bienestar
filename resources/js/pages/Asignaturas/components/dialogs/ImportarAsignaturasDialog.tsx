        ...
        >
            ...
            <DialogContent className="sm:max-w-[640px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Solo se usan las columnas `PROGRAMA ACADEMICO` y `ASIGNATURA`. El sistema crea una sola asignatura por combinación `carrera +
                        nombre` y omite repeticiones dentro del mismo archivo o si ya existen.
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={submit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-xs">
                            `PROGRAMA ACADEMICO` se cruza contra las carreras registradas. `SEMESTRE`, `DOCENTE`, `TUTOR` y demás columnas se ignoran.
                        </p>
                    </div>
