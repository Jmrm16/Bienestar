        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>Completa los datos básicos para registrar una publicación cultural.</DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-4" encType="multipart/form-data">
                    ...
                    <div>
                        ...
                        <select id="tipo" name="tipo" value={form.tipo} onChange={handleChange} className="w-full rounded border px-3 py-2 text-sm">
                    ...
                    <div>
                        ...
                        {errors.imagen_banner && <p className="mt-1 text-sm text-red-500">{errors.imagen_banner}</p>}
                    </div>
