...
export default function EditCultura({ cultura }: EditCulturaProps) {
    ...
    const [contenido, setContenido] = useState<OutputData | null>(() => {
        try {
            ...
            return typeof cultura.contenido_json === 'string' ? JSON.parse(cultura.contenido_json) : cultura.contenido_json;
        } catch (err) {
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
                            ...
                            <div className="flex items-center gap-3">
                                <Switch id="publicado" checked={data.publicado} onCheckedChange={(value) => setData('publicado', value)} />
