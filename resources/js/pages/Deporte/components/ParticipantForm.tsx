...
export function buildParticipantFormValues(participant?: SportParticipant | null): ParticipantFormValues {
...
export function ParticipantForm({
    ...
    const set = <K extends keyof ParticipantFormValues>(key: K, val: ParticipantFormValues[K]) => {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
                ...
                <Select value={value.tipo_doc} onValueChange={(x) => set('tipo_doc', x)} disabled={disabled}>
                    <SelectTrigger>
            ...
            <div className="space-y-2">
                ...
                <Input value={value.documento} onChange={(e) => set('documento', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2">
                <Label>Nombres</Label>
                <Input value={value.nombres} onChange={(e) => set('nombres', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2">
                <Label>Apellidos</Label>
                <Input value={value.apellidos} onChange={(e) => set('apellidos', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2">
                <Label>Estamento</Label>
                <Select value={value.estamento} onValueChange={(x) => set('estamento', x)} disabled={disabled}>
                    <SelectTrigger>
                        <SelectValue placeholder="Selecciona" />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <div className="space-y-2">
                <Label>Estado</Label>
                <Select value={value.estado} onValueChange={(x) => set('estado', x)} disabled={disabled}>
                    <SelectTrigger>
                        <SelectValue placeholder="Selecciona" />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <div className="space-y-2">
                ...
                <Input type="date" value={value.fecha_ingreso} onChange={(e) => set('fecha_ingreso', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2">
                <Label>Telefono</Label>
                <Input value={value.telefono} onChange={(e) => set('telefono', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2">
                <Label>Correo</Label>
                <Input type="email" value={value.correo} onChange={(e) => set('correo', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2">
                <Label>Carrera</Label>
                <Select value={value.carrera_id} onValueChange={(x) => set('carrera_id', x)} disabled={disabled}>
                    <SelectTrigger>
            ...
            <div className="space-y-2">
                ...
                <Input value={value.semestre} onChange={(e) => set('semestre', e.target.value)} disabled={disabled} />
            </div>

            <div className="space-y-2 md:col-span-2">
                <Label>Observaciones</Label>
                <Textarea value={value.observaciones} onChange={(e) => set('observaciones', e.target.value)} disabled={disabled} rows={4} />
            </div>
        </div>
    );
}
