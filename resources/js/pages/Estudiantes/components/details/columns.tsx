...
export const columnsEstudiantes: ColumnDef<Estudiante>[] = [
    ...
    {
        id: 'actions',
        header: () => <div className="w-full text-center text-sm">Acciones</div>,
        size: 140,
        cell: function StudentActionsCell({ row }) {
                        ...
                        <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription className="max-h-[300px] space-y-1 overflow-y-auto">
                        ...
                        <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Actualiza los datos personales del estudiante.</DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4">
                                    <Label>Nombres</Label>
                                    <Input
                                        value={selectedEstudiante.nombres || ''}
                                        onChange={(e) => setSelectedEstudiante({ ...selectedEstudiante, nombres: e.target.value })}
                                    />
                                    <Label>Apellidos</Label>
                                    <Input
                                        value={selectedEstudiante.apellidos || ''}
                                        onChange={(e) => setSelectedEstudiante({ ...selectedEstudiante, apellidos: e.target.value })}
                                    />
                                    <Label>Identificación</Label>
                                    <Input
                                        value={selectedEstudiante.identificacion || ''}
                                        onChange={(e) => setSelectedEstudiante({ ...selectedEstudiante, identificacion: e.target.value })}
                                    />
                                    <Label>Correo Institucional</Label>
                                    <Input
                                        value={selectedEstudiante.correo_institucional || ''}
                                        onChange={(e) => setSelectedEstudiante({ ...selectedEstudiante, correo_institucional: e.target.value })}
                                    />
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction className="bg-red-600 hover:bg-red-700" onClick={eliminarEstudiante}>
                                        Eliminar
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
