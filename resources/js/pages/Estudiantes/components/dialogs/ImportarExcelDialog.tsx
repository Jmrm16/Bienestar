        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[650px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Sube la plantilla de actividades (IDENTIFICACION, NOMBRES Y APELLIDOS, SEXO, etc.)</DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-xs">Formatos permitidos: .xlsx, .xls</p>
                    </div>
