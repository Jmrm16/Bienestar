...
export default function EstudiantesIndex({ carreras, grupos }: Props) {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex flex-col gap-4 rounded-xl p-4 w-full flex-grow">
        ...
        >
          ...
          <div className="mt-6 w-full">
            <p className="text-2xl sm:text-3xl font-bold mb-4">Carreras</p>
          ...
          {/* --- Grupos --- */}
          <div className="mt-6 w-full">
            <p className="text-2xl sm:text-3xl font-bold mb-4">Grupos</p>
            <div className="flex flex-wrap gap-4 mb-4 w-full">
              <AgregarGrupo />
            </div>
            <div className="overflow-x-auto">
