    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Busca un estudiante por nombre, código o cédula para ver sus materias y notas registradas.
          </CardDescription>
        </CardHeader>
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            No encontramos estudiantes con el criterio <span className="font-medium text-foreground">"{search}"</span>.
          </CardDescription>
        </CardHeader>
      </Card>
    );
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {studentResultCount} estudiante(s) encontrados y {matchedRowsCount} registro(s) académicos asociados a <span className="font-medium text-foreground">"{search}"</span>.
          </CardDescription>
        </CardHeader>
      </Card>
