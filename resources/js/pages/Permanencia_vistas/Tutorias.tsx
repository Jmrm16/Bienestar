        ...
        <>
            ...
            <main className="bg-gray-50 text-gray-800">
                ...
                <section className="py-12 text-center">
                    <h1 className="mb-2 text-3xl font-bold text-blue-800">Directorio de Tutorías</h1>
                    <p className="mx-auto max-w-3xl text-lg text-gray-600">
                        Consulta los tutores disponibles por carrera o asignatura y encuentra los canales de atención de Permanencia y Graduación
                        Exitosa en sede Maicao.
                    </p>
                </section>
                ...
                <section className="container mx-auto px-4 pb-12">
                    <div className="mb-10 grid grid-cols-1 gap-4 md:grid-cols-3">
                        <Card className="border-blue-100">
                            <CardContent className="pt-6">
                                <p className="text-sm tracking-wide text-blue-600 uppercase">Tutores registrados</p>
                                <p className="mt-2 text-3xl font-bold text-blue-900">{totalTutores}</p>
                                <p className="mt-2 text-sm text-gray-600">Directorio académico disponible para apoyo en asignaturas priorizadas.</p>
                            </CardContent>
                        </Card>
                        <Card className="border-blue-100">
                            <CardContent className="pt-6">
                                <p className="text-sm tracking-wide text-blue-600 uppercase">Correo del programa</p>
                                <a
                                ...
                                <p className="mt-2 text-sm text-gray-600">Canal institucional para orientación académica y remisiones.</p>
                            </CardContent>
                        </Card>
                        <Card className="border-blue-100">
                            <CardContent className="pt-6">
                                <p className="text-sm tracking-wide text-blue-600 uppercase">Bienestar sede Maicao</p>
                                <p className="mt-2 text-lg font-semibold text-blue-900">(605) 728 2729 ext. 306</p>
                                <p className="mt-2 text-sm text-gray-600">Atención presencial en Calle 16 No. 28A - 80, salida a Riohacha.</p>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    {tutoresFiltrados.length === 0 && (
                        <div className="py-8 text-center">
                            <p className="text-lg text-gray-500">No se encontraron tutores con los filtros seleccionados.</p>
                        </div>
                    )}
                            ...
                            <Card key={tutor.id} className="text-center">
                                <CardHeader>
                                    <Avatar className="mx-auto h-24 w-24">
                                        <AvatarImage src={tutor.imagen || '/img/tutores/default.jpg'} alt={tutor.nombre} className="object-cover" />
                                    </Avatar>
                                ...
                                <CardContent className="space-y-2 text-sm text-gray-600">
                                    ...
                                    {typeof tutor.calificacion === 'number' && (
                                        <Badge variant="secondary" className="font-semibold text-yellow-600">
                            ...
                            {destacados.map((tutor, index) => (
                                <Card key={tutor.id} className="border-l-4 border-yellow-400">
                                    <CardContent className="p-4">
                                        ...
                                        {typeof tutor.calificacion === 'number' ? (
                                            <p className="mt-1 font-bold text-yellow-600">{tutor.calificacion} ⭐</p>
                                        ) : (
                                            <p className="mt-1 font-bold text-blue-700">{tutor.asignaturas.length} asignaturas de apoyo</p>
                                        )}
                                    </CardContent>
                                </Card>
                            ))}
                    ...
                    <Card className="mt-16 border-blue-100 bg-blue-50/70">
                        <CardContent className="py-6 text-center">
                            ...
                            <p className="mt-2 text-gray-700">
                                ...
                                o comunícate con Bienestar Universitario sede Maicao al <span className="font-semibold">(605) 728 2729 ext. 306</span>
                                .
                            </p>
                        </CardContent>
                    </Card>
