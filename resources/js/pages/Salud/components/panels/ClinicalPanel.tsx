...
import { CalendarClock, ClipboardList, Plus, Smile, Stethoscope, Users } from 'lucide-react';
...
export default function ClinicalPanel({ areaKey, panelEnabled = false, records = [], stats, patients = [] }: Props) {
    ...
    const typePlaceholder = isOdontology ? 'Ej. Valoración, limpieza, control' : 'Ej. Consulta general, control, remisión';
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>El panel clínico necesita la tabla de atenciones del módulo.</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between gap-4">
                    <div className="space-y-1">
                        <CardTitle>{isOdontology ? 'Valoraciones y procedimientos' : 'Atenciones y seguimiento'}</CardTitle>
                        <CardDescription>
                            {isOdontology
                                            ...
                                            <TableCell>
                                                {record.paciente ? (
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-muted-foreground text-xs">{record.paciente.documento}</p>
                                                    </div>
                                                ) : (
                                                    'Sin paciente'
                                                )}
                ...
                <DialogContent className="sm:max-w-3xl">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <Textarea value={form.evaluacion} onChange={(e) => setForm((current) => ({ ...current, evaluacion: e.target.value }))} />
                        </div>
                        <div className="space-y-2 md:col-span-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input value={form.responsable} onChange={(e) => setForm((current) => ({ ...current, responsable: e.target.value }))} />
                        </div>
                        <div className="space-y-2">
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleCreate} disabled={!form.tipo || !form.evaluacion}>
                            Guardar
                        </Button>
                    </DialogFooter>
                </DialogContent>
