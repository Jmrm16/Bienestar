...
export default function ImportarResolucionesPeriodoDialog() {
    ...
    const orderedPeriods = useMemo(() => [...periodos].sort((a, b) => b.id - a.id), [periodos]);

    const defaultPeriodId = orderedPeriods.find((periodo) => periodo.is_active)?.id ?? orderedPeriods[0]?.id ?? null;
        ...
        router.post(
            ...
            },
            {
                ...
                onError: (errors) => {
                    ...
                    toast.error(typeof firstError === 'string' ? firstError : 'No se pudo importar el archivo de resoluciones');
                },
        ...
        >
            ...
            <DialogContent className="sm:max-w-[640px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Sube el Excel del período con la resolución de cada tutor. Este archivo solo actualiza `R1/R2` del período elegido y no
                        modifica los datos personales del tutor.
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-xs">
                            Columnas recomendadas: `codigo`, `documento`, `nombre completo` y `tipo_resolucion`. Si la columna de resolución no viene,
                            el sistema intenta deducir `R1` o `R2` del nombre del archivo u hoja.
                        </p>
                    </div>
