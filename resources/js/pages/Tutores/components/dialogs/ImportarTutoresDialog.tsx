        ...
        >
            ...
            <DialogContent className="sm:max-w-[640px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Soporta el formato de admisión con `NOMBRES`, `APELLIDOS`, `TIPO DE DOCUMENTO`, `DOCUMENTO`, `LUGAR DE EXPEDICIÓN`, `SEXO`,
                        `GRUPO PRIRIZADO`, `SEDE`, `PROGRAMA ACADÉMICO`, `CORREO` y `TELEFONO`. `VALORACION ENTREVISTA`, `PUNTAJE PRUEBA DE TABLERO` y
                ...
                <form onSubmit={submit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-xs">
                            Este import solo crea o actualiza los datos base del tutor. La resolución `R1/R2` ahora se carga aparte por período desde
                            `Importar resoluciones`. `PROGRAMA ACADÉMICO` se cruza contra las carreras registradas en el sistema.
                        </p>
                    </div>
