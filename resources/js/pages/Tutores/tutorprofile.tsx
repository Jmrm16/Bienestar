      ...
      <div className="flex flex-col gap-6 rounded-xl p-4">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Perfil administrativo del tutor con resumen de grupos y asistencias.
            </p>
          </div>
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Lugar de expedicion</p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Desde aqui puedes revisar los grupos del tutor y abrir la vista de asistencias por grupo.
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <TableBody>
                    {tutor.grupos.map((grupo) => (
                      <TableRow key={`${grupo.id}-${grupo.period?.id ?? "na"}`}>
                        <TableCell>
                          {grupo.period
                            ? `${grupo.period.code}${grupo.period.name ? ` · ${grupo.period.name}` : ""}`
                            : "—"}
                        </TableCell>
                        ...
                        <TableCell>
                          <Badge variant={grupo.rol === "principal" ? "default" : "outline"}>
                            {textOrDash(grupo.rol)}
                          </Badge>
                        </TableCell>
